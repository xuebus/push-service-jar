...
public class Demo {
	...
	public void sendIOSBroadcast() throws Exception {
		...
		//broadcast.setAlert("广播测试:");
		/*apsJson.put("text","服务态度好");
		broadcast.setPredefinedKeyValue("payload",apsJson);*/
		broadcast.setAlert("新评论通知");
		broadcast.setBadge(0);
		broadcast.setSound( "default");
		// TODO set 'production_mode' to 'true' if your app is under production mode
		broadcast.setTestMode();
		// Set customized fields
		broadcast.setDescription("游客评论导游服务的提醒消息");
		//
		broadcast.setCustomizedField("title", "helloworld");
		client.send(broadcast);
	}
	...
	public void sendIOSUnicast() throws Exception {
		...
		// TODO Set your device token
		unicast.setDeviceToken( "664f7d57f9d5045bced79b085cf6174fbcee7524ea7eafbffea57d270382ea0b");
	...
	public static void main(String[] args) {
		...
		//安卓
		Demo demo = new Demo("58d34858f29d985421000359", "zjltul9wlz2ezo02zmb9regi85dho8p8");
		try {
